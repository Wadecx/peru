...
export const CustomersReviews = () => {
  ...
  return (
    <section className="flex flex-col justify-center text-center bg-primary mt-20">
      <h2 className="uppercase font-black text-4xl my-24">
        DES <span className="text-secondary-light">TÉMOIGNAGES</span> QUI PARLENT
        D’EUX-MÊMES.
      </h2>
            ...
            {Reviews.map((client, index) => (
              <div key={index} className={`w-full md:w-1/4 px-4 shrink-0`}>
                <div className="bg-white p-4 md:p-6 rounded-3xl shadow-lg min-h-[350px] md:h-[300px] flex flex-col justify-between mb-4 text-start">
                  ...
                  <h3 className="text-secondary-light text-xl font-black">{client.name}</h3>
