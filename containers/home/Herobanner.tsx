...
export const Herobanner = () => {
  return (
    <section className="bg-primary flex justify-center pt-24 flex-col text-center max-w-[97%] mx-auto">
      <div className="">
      ...
      <div className="uppercase flex gap-4 justify-center mt-4 font-medium">
      ...
      <div className="w-full h-[671px] bg-[url('/assets/images/home/hero-banner.png')] bg-cover bg-no-repeat rounded-bl-3xl rounded-br-3xl"></div>
